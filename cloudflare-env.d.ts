/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 1daa1b6cde2e2eda4760046c04e0f658)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* next-announcement */;
	}
}
